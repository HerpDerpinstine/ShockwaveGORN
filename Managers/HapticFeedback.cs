...
using ShockwaveGORN.Setup.Weapons;
using ShockwaveGORN.Setup.Weapons.Caestus;

namespace ShockwaveGORN.Managers
{
    public static class M_HapticFeedback
    {
        ...
        public static E_PlayerDamage playerDamage;
