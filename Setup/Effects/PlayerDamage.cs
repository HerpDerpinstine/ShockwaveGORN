...
{
	public class E_PlayerDamage : I_EffectBase
	{
		...
		public void Play(Vector3 contactPos, Vector3 velocity)
		{
			if (!Config.HapticEffects.PlayerDamage || !Torso.IsEnabled())
				return;
			...
			intensity, eHapticRegion.TORSO, eHapticSide.FRONT, angle);
		}
	}
}