...
namespace ShockwaveGORN.Hooks
{
    internal static class H_Bow
    {
        ...
        private static void FireArrow_Prefix(Bow __instance)
        {
            ...
            M_HapticFeedback.WeaponsByType[WeaponType.Bow]?.OnShootString(__instance.grabbedBy.ownerFist.left);
        }
        ...
        private static void RunSound_Prefix(Bow __instance)
        {
            ...
            M_HapticFeedback.WeaponsByType[WeaponType.Bow]?.OnDrawString(magnitude, !__instance.grabbedBy.ownerFist.left);
        }
    }
}
