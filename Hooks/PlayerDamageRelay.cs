...
namespace ShockwaveGORN.Hooks
{
    internal static class H_PlayerDamageRelay
    {
        ...
        internal static void Initialize()
        {
            ...
            ShockwaveGORN.ModHarmony.Patch(AccessTools.Method(Type_PlayerDamageRelay, "Update"), 
                null,
                null,
            ...
            ShockwaveGORN.ModHarmony.Patch(AccessTools.Method(Type_PlayerDamageRelay, "Damage"),
                null,
                null,
            ...
            bool isFloor)
        {
            ...
            switch (damageType)
            {
                case DamageType.Arrow:
                    M_HapticFeedback.playerDamage_Arrow.Play(pos, velocity);
                    break;
                default:
                    M_HapticFeedback.playerDamage.Play(pos, velocity);
                    break;
            }
        }
    }
